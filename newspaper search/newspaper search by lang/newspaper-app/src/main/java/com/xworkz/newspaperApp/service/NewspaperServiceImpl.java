...
public class NewspaperServiceImpl implements NewspaperService {
	...
	@Override
	public NewspaperDTO getNewspaper(String language) {
		System.out.println("Invoked getNewspaper");
		NewspaperEntity entity = this.newspaperDAO.getNewspaperEntityByLang(language);
		if(entity != null) {
			NewspaperDTO dto = new NewspaperDTO(); 
			BeanUtils.copyProperties(entity, dto);
			return dto;
